...
/*
void dijkstrouille(int p)
{
	const int nbSommets = 7;
	int noeud_depart = 0;
	int noeud_arrivee = 6;
...
{
	// Pour mettre notre structure dans un set il nous faut cet opérateur
...
static double calculateH(int x, int y, Node destination) 
{
